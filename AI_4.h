...
void AI_4(int &u,int Rx,int Ry, int r, int **U, int **A, int **Rip, int **Ru, int **At, int *K, int *T, int *HP, int *UA, int *Kasa,int *Team, int team, int sciezka)
{
...
//[AI][Ruch][Kmiotek][Rycerz]
				if(K[U[k][i]]==2 || K[U[k][i]]==1 || K[U[k][i]]==77 || K[U[k][i]]==6)
				{
//[AI][Ruch][Kmiotek][Rycerz]Szukanie najblizszego domku lub zamku
					...
					for(int ni=0;ni<Ry;++ni)
					{
						...
						{
//[AI][Ruch][Kmiotek]Szukanie najblizszego domku lub krola (o ile maj¹ wiêcej ni¿ 60HP)
							if((K[lu]==2)&&((A[nk][ni]!=teamVillage(team))&&(10!=whatTeam(A[nk][ni]))&&(11!=A[nk][ni])&&(25!=A[nk][ni])&&(12!=A[nk][ni])&&(24!=A[nk][ni])&&(13!=A[nk][ni])&&(26!=A[nk][ni])&&(23!=A[nk][ni]) || ( K[U[nk][ni]]==77 && T[U[nk][ni]]!=team && HP[lu]>60)))
							{
								d=abs(ni-i)+abs(nk-k);
								if(d<nd)
								{
...
//[AI][Ruch][Rycerz]Szukanie najblizszego domku, zamku lub króla (o ile maj¹ wiêcej ni¿ 40HP)
							if((K[lu]==1)&&((A[nk][ni]!=teamCastle(team))&&(A[nk][ni]!=teamVillage(team))&&(10!=whatTeam(A[nk][ni])) || ( K[U[nk][ni]]==77 && T[U[nk][ni]]!=team && HP[lu]>40)))
...
//[AI][Ruch][Lucznik]Szukanie najblizszego przeciwnika
							if(K[lu]==6 && U[nk][ni] && T[U[nk][ni]]!=team)
							{
								d=abs(ni-i)+abs(nk-k);
								if(d<nd)
								{
...
//[AI][Ruch]Pozostawanie na domku
				if(A[k][i]==teamVillage(T[lu]) || A[k][i]==teamCastle(T[lu]))
				{
					x=lx;
					y=ly;
				}
...
//[AI][Atak]Szukanie przeciwnikow o wyzszym priorytecie zniszczenia
				for(int ri=0;ri<Ry;++ri)
				{
					for(int rk=0;rk<Rx;++rk)
					{
						if((At[rk][ri]==1 || (At[rk][ri]>0 && K[U[rk][ri]]==77))&&(U[rk][ri])&&(T[U[rk][ri]]!=team))
						{
							x=rk;
							y=ri;
						}
...
//[AI][Kupowanie][Ruch][Kmiotek][Rycerz]Szukanie najblizszego domku lub zamku
		...
		for(int ni=0;ni<Ry;++ni)
		{
			for(int nk=0;nk<Rx;++nk)
			{
//[AI][Kupowanie][Ruch][Kmiotek]Szukanie najblizszego domku lub króla (o ile maj¹ wiêcej ni¿ 60HP)
				if((zakup==2)&&((A[nk][ni]!=teamVillage(team))&&(10!=whatTeam(A[nk][ni]))&&(11!=A[nk][ni])&&(25!=A[nk][ni])&&(12!=A[nk][ni])&&(24!=A[nk][ni])&&(13!=A[nk][ni])&&(26!=A[nk][ni])&&(23!=A[nk][ni]) || ( K[U[nk][ni]]==77 && T[U[nk][ni]]!=team && HP[lu]>60)))
				{
...
//[AI][Kupowanie][Ruch][Rycerz]Szukanie najblizszego domku, zamku lub króla (o ile maj¹ wiêcej ni¿ 40HP)
				if((zakup==1)&&((A[nk][ni]!=teamCastle(team))&&(A[nk][ni]!=teamVillage(team))&&(10!=whatTeam(A[nk][ni])) || ( K[U[nk][ni]]==77 && T[U[nk][ni]]!=team && HP[lu]>40)))
				//if((K[lu]==1)&&(A[nk][ni]!=teamCastle(team))&&(10!=whatTeam(A[nk][ni]))&&(27!=A[nk][ni])&&(29!=A[nk][ni])&&(30!=A[nk][ni])&&(28!=A[nk][ni])&&(31!=A[nk][ni])&&(32!=A[nk][ni])&&(10!=A[nk][ni]))
				{
					d=abs(ni-ky)+abs(nk-kx);
					if(d<nd)
...
//[AI][Kupowanie][Ruch][Lucznik]Szukanie najblizszego przeciwnika
				if(zakup==6 && U[nk][ni] && T[U[nk][ni]]!=team)
				{
					d=abs(ni-ky)+abs(nk-kx);
					if(d<nd)
					{
